...
public:
    ...
    ParsedDeck ParseDeckById(std::string deck_code);
    ParsedDeck ParseDeckFromJson(json deck_json,bool print);
    std::vector<Card*> AdaptDeckList(std::vector<std::string> deck_list);
